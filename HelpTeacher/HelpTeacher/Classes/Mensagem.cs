...
namespace HelpTeacher.Classes
{
    public static class Mensagem
    {
        ...
        // BANCO  BANCO BANCO  BANCO BANCO  BANCO BANCO  BANCO BANCO BANCO  BANCO  BANCO  BANCO  BANCO  //
        public static void falhaNaConexao()
        {
            MessageBox.Show("Sem conexão com o banco de dados!", "Conexão Falhou",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
        }

        public static void inicializandoBanco()
        {
            MessageBox.Show("Tentando iniciar banco de dados. \nAguarde um momento.",
                    "Falha na Conexão", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

        public static void falhaInicializacaoBanco()
        {
            MessageBox.Show("Falha na inialização do banco. \nTente novamente ou contate o administrador do sistema.",
                    "Falha Inicialização Banco", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }

        public static void tabelasBancoFaltando()
        {
            MessageBox.Show("O Help Teacher tentará criar as tabelas automaticamente. \nAguarde a finalização do procedimento.",
                    "Tabelas Faltando", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        public static void erroComandoSQL()
        {
        ...
        public static void falhaEncerramentoBanco()
        {
            MessageBox.Show("Falha no fechamento do banco.", "Falha Encerramento Banco",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        ...
        {
            MessageBox.Show("Login ou senha inválidos. Tente novamente.", "Erro Login",
                    MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }

        // CADASTRO QUESTAO CADASTRO QUESTAO  CADASTRO QUESTAO CADASTRO QUESTAO CADASTRO QUESTAO  //
        // CADASTRO QUESTAO CADASTRO QUESTAO  CADASTRO QUESTAO CADASTRO QUESTAO CADASTRO QUESTAO  //
        public static void alternativasEmBranco()
        {
            MessageBox.Show("Alternativa não preenchida.", "Alternativa em Branco",
                    MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }

        // CADASTRO CURSO CADASTRO CURSO  CADASTRO CURSO CADASTRO CURSO CADASTRO CURSO  CADASTRO CURSO  //
        // CADASTRO CURSO CADASTRO CURSO  CADASTRO CURSO CADASTRO CURSO CADASTRO CURSO  CADASTRO CURSO  //
        public static void cursoExistente()
        {
            MessageBox.Show("Já existe um registro relacionado a este curso. \nVerifique e tente novamente",
        ...
        // CADASTRO DISCIPLINA CADASTRO DISCIPLINA  CADASTRO DISCIPLINA CADASTRO DISCIPLINA CADASTRO  //
        public static void disciplinaExistente()
        {
            MessageBox.Show("Já existe um registro relacionado a esta disciplina. \nVerifique e tente novamente",
        ...
        // CADASTRO MATÉRIA CADASTRO MATÉRIA  CADASTRO MATÉRIA CADASTRO MATÉRIA CADASTRO MATÉRIA  //
        public static void materiaExistente()
        {
            MessageBox.Show("Já existe um registro relacionado a esta matéria. \nVerifique e tente novamente",
        ...
        // GERAÇÃO AVALIAÇÃO  GERAÇÃO AVALIAÇÃO  GERAÇÃO AVALIAÇÃO  GERAÇÃO AVALIAÇÃO  GERAÇÃO AVALIAÇÃO  GERAÇÃO  //
        public static void avaliacaoSemQuestoes()
        {
            MessageBox.Show("É necessário ter ao menos uma questão para gerar a avaliação.", 
                    "Sem Questões", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }

        public static Boolean gerarAvaliacaoNovamente()
        {
        ...
        // GERAIS  GERAIS GERAIS  GERAIS GERAIS  GERAIS GERAIS  GERAIS GERAIS GERAIS  GERAIS  GERAIS  //
        public static void procedimentoFinalizado()
        {
        ...
        {
            MessageBox.Show("Senhas incompatíveis. Tente novamente.", "Senhas Diferentes",
                    MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }

        public static void cadastradoEfetuado()
        {
            MessageBox.Show("Cadastro efetuado com sucesso.", "Cadastrado Efetuado",
                    MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

        public static void erroCadastro()
        {
            MessageBox.Show("Falha ao tentar fazer o cadastro. \nVerifique sua conexão com o banco e tente novamente",
                    "Erro Cadastro", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }

        public static void dadosAlterados()
        {
            MessageBox.Show("Alteração efetuada com sucesso.", "Dados Alterado",
                     MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

        public static void erroAlteracao()
        {
            MessageBox.Show("Falha ao tentar modificar os dados. \nVerifique sua conexão com o banco e tente novamente",
                    "Erro Alteração", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }

        public static void selecionarMateria()
        {
            MessageBox.Show("Nenhuma matéria selecionada.", "Selecionar Matéria",
                    MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }

        public static void campoEmBranco()
        {
            MessageBox.Show("Preencha todos os campos.", "Campo em Branco",
                    MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }
    }
}
