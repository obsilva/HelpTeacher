...
namespace HelpTeacher.Forms
{
    public partial class Principal : Form
    {
        ...
        private void telaCadastroQuestao()
        {
            ...
            cadastraQuestao.FormClosed += new FormClosedEventHandler(this.ativaCadastroQuestoes);
            abre(cadastraQuestao);
        }

        private void ativaCadastroQuestoes(object sender, FormClosedEventArgs e)
        {
            cadastrarMenuQuestoes.Enabled = true;
        }
        // ********************************************************************************************************* //
        private void pesquisarMenuQuestoes_Click(object sender, EventArgs e)
        {
            busca(1);
        }
        ...
        private void ativaMenuConteudo(object sender, FormClosedEventArgs e)
        {
            cadastrarMenuConteudo.Enabled = true;
        }
        // ********************************************************************************************************* //
        private void pesquisarMenuConteudo_Click(object sender, EventArgs e)
        {
            busca(2);
        }
        ...
        private void ativaGerarAvaliacao(object sender, FormClosedEventArgs e)
        {
            gerarMenuAvaliacoes.Enabled = true;
        }
        // ********************************************************************************************************* //
        private void historicoMenuAvaliacoes_Click(object sender, EventArgs e)
        {
            busca(3);
        }
        ...
        private void ativaConfiguracoes(object sender, FormClosedEventArgs e)
        {
            configuracoesMenuUsuario.Enabled = true;
        }
        // ********************************************************************************************************* //
        ...
        // ********************************************************************************************************* //
        private void sairMenuUsuario_Click(object sender, EventArgs e)
        {
            Application.Exit();
        }
        ...
        private void ativaAjuda(object sender, FormClosedEventArgs e)
        {
